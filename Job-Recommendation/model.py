"""
PyTorch model definitions — extracted from the training notebook.
"""
...
class HGTModel(torch.nn.Module):
    def __init__(self, metadata, in_channels_dict, hidden=128, num_layers=2, dropout=0.2):
        super().__init__()
        self.dropout = dropout
        self.convs = torch.nn.ModuleList()
        self.convs.append(HGTConv(in_channels_dict, hidden, metadata, heads=2))
